...
const CTAWhatsApp = ({ 
  ...
  className = "",
  onClick,
  href = "https://wa.me/436677680897?text=Hallo%20Nikola,%20bitte%20um%20kurze%20Chef-Besichtigung%20in%20[Ort].%20Wunschtermin:%20[Datum/Uhrzeit].",
  ...
  return (
    ...
    >
      <i className="fab fa-whatsapp text-xl mr-2 flex-shrink-0"></i>
